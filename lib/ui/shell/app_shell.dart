...
class AppShell extends StatelessWidget {
  const AppShell({super.key, required this.desktopController});

  final DesktopShellController desktopController;
    ...
    return LayoutBuilder(
      builder: (BuildContext context, BoxConstraints constraints) {
        return switch (formFactorFor(constraints.maxWidth)) {
          FormFactor.expanded => ExpandedShell(controller: desktopController),
